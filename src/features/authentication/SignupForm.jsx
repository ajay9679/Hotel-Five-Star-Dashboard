...
export default function SignupForm(){
    ...
    return <Form onSubmit={handleSubmit(onSubmit)} >
        ...
        <FormRow label="Repeat password" errorMessage={errors?.passwordConfirm?.message}>
            <Input type="password" id="passwordConfirm" {...register('passwordConfirm',{required:'This field is required!',validate:value => value === getValues().password || 'Password needs to be match.'})} />
        </FormRow>
